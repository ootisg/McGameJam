...
public class PipeOverlayer2 extends GameObject {
	...
	public PipeOverlayer2 () {
		
	}
	@Override
	public void onDeclare () {
		Rectangle bounds = new Rectangle ((int)this.getX(),(int)this.getY(),400,96);
		this.bounds = bounds;
		this.setHitbox (bounds.x, bounds.y, bounds.width, bounds.height);
		setSprite (new Sprite ("resources/bg/pipeOverlay2.png"));
